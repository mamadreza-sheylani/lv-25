const answers_no = {
    ...
    persian:[
        ...
        "یعنی واقعا مطمعنی؟؟؟",
        "دوباره فکر کن",
        "به شانس دوباره باور نداری؟",
        "انقد سرد نباش دیگه اه",
        "بنظرم صحبت کنیم درموردش!",
        "نذار دوباره سوال کنم!",
        "خب الان دیگه جدی داری ناراحتم میکنی",
        "چقد بدجنسی اخه",
        "ای نامرد چرا اینکارو میکنی اخه",
        "یکم بیشتر فکر کن",
        "بسه دیگه آره رو بزن !",
        "دوباره از اول شروع کنیم پس",
    ],
    french: [
        "Non",
        "Tu es sûr ?",
...
let language = "persian"; // Default language is English
